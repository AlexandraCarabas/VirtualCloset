...
import com.example.virtualcloset.databinding.ActivityDressesBinding
...
class DressesActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityDressesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.ivAddItem.setOnClickListener{
            startActivity(Intent(this@DressesActivity,AddItemActivity::class.java))
        }
